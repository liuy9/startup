...
public class StatusBarUtil {
    ...
    public static final int SYSTEM_MIUUI = 1;
    public static final int SYSTEM_FLYME = 2;
    public static final int SYSTEM_ANDROID6_0 = 3;
    public static final int SYSTEM_OTHERS = 0;
    ...
    public static void StatusBarLightMode(Activity activity, int type) {
        if (type == SYSTEM_MIUUI) {
            MIUISetStatusBarLightMode(activity.getWindow(), true);
        } else if (type == SYSTEM_FLYME) {
            FlymeSetStatusBarLightMode(activity.getWindow(), true);
        } else if (type == SYSTEM_ANDROID6_0) {
            activity.getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        }
