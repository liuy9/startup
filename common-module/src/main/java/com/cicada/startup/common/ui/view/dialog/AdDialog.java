...
public class AdDialog extends Dialog implements View.OnClickListener {
    ...
    private void showImageUrl() {
        if (null != photoView) {
            GlideImageDisplayer.display(context, photoView, imageUrl);
        }
    }

    private void showImageRes() {
        if (null != photoView) {
            GlideImageDisplayer.display(context, photoView, imageRes);
        }
    }
...
//                TCAgent.onEvent(AppContext.getContext(), "精选弹屏banner-跳转链接");
            }
